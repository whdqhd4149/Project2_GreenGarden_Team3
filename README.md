...
본 프로젝트에서 저는 **회원 기능과 서비스 정책 기능을 담당했습니다.**  
일반 로그인과 Google 소셜 로그인을 포함한 회원 인증 흐름을 구현하고,  
회원가입 및 계정 찾기 기능과 서비스 정책 페이지를 구성했습니다.

### 담당 기능

- 일반 로그인 및 Google 소셜 로그인 기능 구현
- 회원가입 구분, 약관 동의, 일반회원/판매자 회원가입 기능 구현
- 아이디 찾기, 비밀번호 찾기 및 비밀번호 변경 기능 구현
- 구매회원/판매회원 약관, 전자금융거래 약관, 위치정보 이용약관, 개인정보처리방침 페이지 구현
