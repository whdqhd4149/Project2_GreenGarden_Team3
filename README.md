...
관리자 권한인 `ROLE_ADMIN`이 확인되면 관리자 메인 페이지인 `/admin/`으로 이동하고, 일반회원과 판매회원은 사용자 메인 페이지인 `/`로 이동하도록 구성했습니다.
...
Google 로그인에 성공하면 사용자 메인 페이지인 `/`로 이동하고, 인증에 실패하면 로그인 화면에서 오류를 확인할 수 있도록 처리했습니다.
...
> 이메일 또는 휴대폰 정보를 입력하는 아이디 찾기 화면 캡처 추가 예정

<!-- 이미지 추가 위치: docs/images/find-id.png -->

### 📷 아이디 찾기 결과 화면

> 아이디 찾기 결과 화면 캡처 추가 예정

<!-- 이미지 추가 위치: docs/images/find-id-result.png -->
...
> 아이디와 이메일 또는 휴대폰 정보를 입력하는 비밀번호 찾기 화면 캡처 추가 예정

<!-- 이미지 추가 위치: docs/images/find-password.png -->

### 📷 비밀번호 변경 화면

> 새로운 비밀번호를 입력하는 비밀번호 변경 화면 캡처 추가 예정

<!-- 이미지 추가 위치: docs/images/change-password.png -->
